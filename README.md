...
I build the guardrails between AI agents and production systems.
Most of that work is deciding what an agent should not be allowed to do.
...
I write at [DEV](https://dev.to/topunix) about Django security, async task
